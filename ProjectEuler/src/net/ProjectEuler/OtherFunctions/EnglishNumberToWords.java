package net.ProjectEuler.OtherFunctions;
...
public class EnglishNumberToWords {
    ...
    private static final ArrayList<Integer> setkiNazwy = new ArrayList<>();
    ...
    public static String convertLessThanOneThousand(int number) {
        ...
        if(number == 10 && soFar.equals("")) {
            return numNames[1] + " thousand";
        } else if(setkiNazwy.contains(number) && soFar.equals("")){
